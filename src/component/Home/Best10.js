   ...
   <div className="row my-5" >
    ...
    <div className="card px-2" style={{backgroundColor:"lavenderblush"}}>
          <div className="card-body">
            ...
            <p className="card-title heading" style={{  fontFamily: "'Playpen Sans', 'cursive'",fontSize:'1.7em'}}><strong>6 Quick & Easy Overnight Oats Recipes, Simplify your Morning Routine with these Effortless Nutritious Breakfast. </strong> </p>
