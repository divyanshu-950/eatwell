...
function QuickEasy(props) {
  ...
  return (
    <div>
      ...
      <p className="mx-1 fn-1  text-center t-content ">This collection of {props.title} is designed to fit into your busy schedule while delivering the taste and nourishment you crave.  </p>
      <hr className="mx-2"/>
      <div className="row">
        {recipes &&
          recipes.map((e,i) => {
